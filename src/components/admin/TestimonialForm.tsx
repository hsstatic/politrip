...
export default function TestimonialForm({ mode, id, defaults }: TestimonialFormProps) {
  ...
  const create = useAdminMutation(api.testimonials.create);
  const update = useAdminMutation(api.testimonials.update);
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6 w-full max-w-2xl">
      <section className="bg-ink/5 border border-ink/10 rounded-xl p-5 space-y-4">
        <h2 className="text-sm font-medium text-ink/70 uppercase tracking-wider">{L.sections.guest}</h2>
      ...
      <section className="bg-ink/5 border border-ink/10 rounded-xl p-5 space-y-4">
        <h2 className="text-sm font-medium text-ink/70 uppercase tracking-wider">{L.sections.reviewText}</h2>
      ...
      <section className="bg-ink/5 border border-ink/10 rounded-xl p-5 space-y-4">
        <h2 className="text-sm font-medium text-ink/70 uppercase tracking-wider">{L.sections.tripMeta}</h2>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
      ...
      <div className="flex flex-wrap gap-3">
        ...
        <button type="button" onClick={() => router.push('/admin/testimonials')} className="px-5 py-2.5 border border-ink/10 text-ink/60 hover:text-ink text-sm rounded-lg transition-colors">
