        ...
        >
          <div className="flex flex-wrap gap-6 items-center justify-between">
            <div>
              ...
              <a href="https://wa.me/905300709555" target="_blank" rel="noopener noreferrer" className="text-sm text-white/80 hover:text-accent transition-colors ltr-only">+90 530 070 95 55</a>
            </div>
