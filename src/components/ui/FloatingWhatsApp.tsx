  ...
  return (
    ...
    >
      ...
      <motion.a
        ...
        transition={{ delay: 2.5, duration: 0.5, ease: EASE_OUT }}
        whileHover={{ scale: 1.1 }}
        whileTap={{ scale: 0.95 }}
        onMouseEnter={() => setTooltip(true)}
        onMouseLeave={() => setTooltip(false)}
        className="w-14 h-14 rounded-full flex items-center justify-center shadow-[0_8px_32px_rgba(37,211,102,0.4)] pulse-glow"
