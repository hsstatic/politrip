  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6 w-full max-w-3xl">
      <section className="bg-white/5 border border-white/10 rounded-xl p-5 space-y-4">
        <h2 className="text-sm font-medium text-white/70 uppercase tracking-wider">{L.sections.name}</h2>
        <LocalizedRow labelBase={L.fields.name} keyBase="name" values={f} onChange={set} />
      </section>

      <section className="bg-white/5 border border-white/10 rounded-xl p-5 space-y-4">
        <h2 className="text-sm font-medium text-white/70 uppercase tracking-wider">{L.sections.tagBadge}</h2>
      ...
      <section className="bg-white/5 border border-white/10 rounded-xl p-5 space-y-4">
        <h2 className="text-sm font-medium text-white/70 uppercase tracking-wider">{L.sections.description}</h2>
      ...
      <section className="bg-white/5 border border-white/10 rounded-xl p-5 space-y-4">
        <h2 className="text-sm font-medium text-white/70 uppercase tracking-wider">{L.sections.appearance}</h2>
